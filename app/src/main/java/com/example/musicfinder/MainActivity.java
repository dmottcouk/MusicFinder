...
public class MainActivity extends Activity {
	...
	public final static String MUSIC_SEARCHES_SYMBOL = "com.dmott.musicfinder1.SEARCHES";
	
	private SharedPreferences musicSearchesEntered;
	
	private TableLayout musicTableScrollView;
	
	private EditText musicEditText;
	private Spinner genreSpinner;
	
	Button enterMusicSearchButton;
	Button getSavedEventsButton;
